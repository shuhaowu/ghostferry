...
// The BinlogReconciler is a required algorithm for catching up the binlog
// events missed while Ghostferry is down for the database table schema has
// changed on either the source or the target.
//
...
func (r *BinlogReconciler) Run() error {
...
func (r *BinlogReconciler) replaceModifiedRows() error {
...
func (r *BinlogReconciler) fetchRowData(table *schema.Table, pk uint64) (RowData, error) {
