...
// Must pass struct in as a pointer as we are assigning Params in this method.
...
type Config struct {
	...
	// NoVerification
	//
	// If it is left blank, the Verifier provided to Ferry will be used. If no
	// Verifier instance is passed to the Ferry, no verification will be done.
	VerifierType string
