...
func setupSingleTableDatabase(sourceDB, targetDB *sql.DB) {
	maxId := 1111
...
func setupSingleTableDatabaseWithHighBitUint64PKs(sourceDB, targetDB *sql.DB) {
...
func setupSingleTableDatabaseWithExtraNullColumn(sourceDB, targetDB *sql.DB) {
	setupSingleTableDatabase(sourceDB, targetDB)
